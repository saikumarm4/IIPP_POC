...
class ClickerState:
    ...
    (self.total_cookies, self.cookies_in_hand, self.game_time, self.current_cps)
    ...
    def time_until(self, cookies):
        ...
        """
        if self.cookies_in_hand >= cookies:
            return 0.0 
        return math.ceil(cookies / self.current_cps)
    ...
    def buy_item(self, item_name, cost, additional_cps):
        ...
        """
        if self.cookies_in_hand >= cost:
            self.cookies_in_hand -= cost
            self.current_cps += additional_cps
            self.history.append((self.game_time, item_name,\
